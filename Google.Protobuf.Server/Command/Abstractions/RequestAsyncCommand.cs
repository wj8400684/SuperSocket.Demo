...
public abstract class RequestAsyncCommand
    : IAsyncCommand<CommandSession, CommandPackage>
{
    ...
    /// <returns></returns>
    protected abstract ValueTask OnHandlerAsync(CommandSession session, CommandPackage package, CancellationToken cancellationToken);
